$(document).ready(function () {
    ...
    $(".supprimer").click(function (e) {
        ...
        $prototype = $("#div-" + id[1]);
        // var url = "{{ path('ajax', { 'id' : 'text' }) }}"
        // url = url.replace("text", id[1]);
    ...
    if (index == 0) {
        ...
        $container.children('div').each(function () {
            addDeleteLink($(this));
            for (var i = 0; i < index; i++) {
                $('#tricksbundle_tricks_video_' + i + '_link').addClass("form-control");
            }
        });
    }
    ...
    if (index2 == 0) {
        ...
        $container2.children('div').each(function () {
            ...
            for (var i = 0; i < index2; i++) {
                $('#tricksbundle_tricks_image_' + i + '_link').addClass("form-control");
                $('#imageAdd div').css("display", "none")
            }
        });
    }
    ...
    function addDeleteLink($prototype) {
        // Création du lien
        var $deleteLink = $('<div class="col-md-2" ><a href="#" class="btn btn-danger">Supprimer</a></div>');
        // Ajout du lien
